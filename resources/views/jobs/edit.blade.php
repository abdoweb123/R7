                     ...
                     <div class="card-body">
                         <form action="{{ route('jobs.update',$job->id) }}" method="POST" enctype="multipart/form-data">
                             ...
                             <div class="row mb-3">
                                 ...
                                 <div class="col">
                                     <label class="mr-sm-2">خطوط الطول</label>
                                     <input type="text" name="longitude" value="{{old('longitude', $job->longitude)}}" class="form-control">
                                 </div>
                             </div>
                             ...
                             <div class="row mb-3">
                                 <div class="col">
                                     <label class="mr-sm-2">خطوط العرض</label>
                                     <input type="text" name="latitude" value="{{old('latitude', $job->latitude)}}" class="form-control">
                                 </div>
                                 <div class="col">
                                     <label class="mr-sm-2">وقت التنفيذ بالأيام</label>
                                     <input type="number" name="duration_by_day" value="{{old('duration_by_day', $job->duration_by_day)}}" class="form-control">
