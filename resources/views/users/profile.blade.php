        ...
        <div class="col-xl-12 mb-30">
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">تعديل الملف الشخصي </h4>
                ...
                <div class="box-body wizard-content">
                    ...
                    @else
                    <form action="{{ route('update-profile',$company->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                            <div class="col">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                <label class="mr-sm-2">الصوره  </label>
                                <input type="file" name="logo_image" value="{{old('logo_image')}}" class="form-control">
                            </div>
