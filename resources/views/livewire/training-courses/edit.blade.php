        ...
        <div class="card-body col-md-8 offset-2">
            <div class="form-group row">
                ...
                <div class="col-md-12 mb-5">
                    <label for="provided_by" class="mr-sm-2"> provided_by </label>
                 ...
                 <div class="col-md-12 mb-5">
                    <label for="provided_by_type">provided_by_type</label>
                ...
                @if ($provided_by_type == 1)
                    ...
                    <div class="col-md-12 mb-5">
                        <label for="company_cost" class="mr-sm-2"> company cost</label>
                ...
                @else
                    <div class="col-md-12 mb-5">
                        <label for="app_cost" class="mr-sm-2"> app cost</label>
                ...
                <div class="col-md-12 mb-5">
                    <label for="total_cost" class="mr-sm-2"> total cost</label>
                ...
                <div class="col-md-12 mb-5">
                    <label for="employee_cost" class="mr-sm-2"> employee cost</label>
